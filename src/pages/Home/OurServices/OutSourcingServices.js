      ...
      <div className="card-column left-column">
        <div className="card-content color-bg-v1">
          ...
          <p>
            ...
            IT-enabled business process, application service and infrastructure
            solutions for business outcomes. The lack and cost of experienced IT
            experts on local markets drives most companies towards It
            outsourcing. Vietnam growth over the last 25 years to a leading
            worldwide outsourcing destination in South East Asia as it provides
            the best cost-efficient outsourcing services with proven high
            performance and quality deliveries.
          </p>
          <button
